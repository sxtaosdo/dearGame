...
//                egret.Logger.info(k);
    ...
    public doOnce(delay: number,method: Function,args: Array<any> = null,cover: boolean = true): any {
     ...
     * @param	cover  是否覆盖(true:同方法多次计时，后者覆盖前者。false:同方法多次计时，不相互覆盖)
     * @return  cover=true时返回回调函数本身，cover=false时，返回唯一ID，均用来作为clearTimer的参数*/
    public doLoop(delay: number,method: Function,args: Array<any> = null,cover: boolean = true): any {
