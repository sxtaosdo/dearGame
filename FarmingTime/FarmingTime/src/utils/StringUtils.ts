class StringUtils {
    ...
    public static getStrByUnits(money: number): string {
        ...
        var yi: number = Math.floor(money / 100000000);
        var wan: number = Math.floor((money % 100000000) / 10000);
        var ge: number = Math.floor(money % 10000);
...
//        return string.fromCharCode(parseInt(Math.random() * (0x9000 - 0x5000)) + 0x5000);
//    }
}